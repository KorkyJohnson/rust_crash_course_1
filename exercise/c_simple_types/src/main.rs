...
use ding_machine::print_difference;     // even though the folder is in c_simple...
use ding_machine::print_array;          // we use the 'name' of the program found in the Cargo.toml
